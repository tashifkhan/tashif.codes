...
export const resumeAbout = {
	greeting: "Holaaaa! 👋",
	introHtml: `I'm an engineering undergraduate in <span class="text-foreground font-medium">Delhi, India</span>, and almost everything I've built starts the same way. I run into something broken, usually college IT, get annoyed enough, and fix it. The campus WebKiosk portal was never meant for phones, so I wrote a React PWA over it from my hostel room. That PWA grew into the <span class="text-foreground font-medium">JIIT Tools Suite</span>, which serves <span class="text-foreground font-medium">18,000+ daily users</span> now, a number I still find slightly surreal. The same reflex explains the rest of this page. Seven stats APIs and <span class="text-foreground font-medium">CodeTrace</span> happened because keeping every leaderboard tab open after a contest felt dumb. The <span class="text-foreground font-medium">home lab</span> happened because renting other people's computers got boring. Lately the actual work is <span class="text-foreground font-medium">full-stack apps and generative AI</span>. Engineering student by day, <span class="text-foreground font-medium">developer and debater</span> by night. Mostly I use code to solve real problems, and by real problems I mean my own laziness.`,
