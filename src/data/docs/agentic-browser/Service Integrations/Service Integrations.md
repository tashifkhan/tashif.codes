...
## Introduction
Map of external integrations: Gmail, Calendar, GitHub, YouTube, website analysis, academic portal. Where services, routers, tools, and prompts live.
...
## Conclusion
New integration checklist: `services/`, `models/`, `routers/`, `tools/`, and prompts. Keep those layers aligned or debugging gets miserable.
