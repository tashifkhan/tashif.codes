...
- Python backend service for reliable contact extraction and validation
...
The system integrates Electron IPC with a Python backend Flask service for reliable file processing.
