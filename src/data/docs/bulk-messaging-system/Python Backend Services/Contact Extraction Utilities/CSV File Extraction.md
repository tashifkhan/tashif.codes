...
- Column detection and fallback parsing: `extract_contacts.py`
- Phone number cleaning and validation: `extract_contacts.py`
- Flask API CSV extraction: `app.py`
- Manual number parsing: `parse_manual_numbers.py`
