...
FastAPI REST surface for TalentSync. Routers mount under `/api/v1` and `/api/v2`, with per-request LLM headers, CORS, and request logging.
...
- LangChain stack: LLM integrations (OpenAI, Anthropic, Google, Ollama).
