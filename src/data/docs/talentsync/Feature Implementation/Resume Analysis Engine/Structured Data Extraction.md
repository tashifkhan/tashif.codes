...
- Data processor: Orchestrates text formatting, JSON formatting, and detailed analysis via LLM chains
...
- POST /resume/detailed/analysis/: Detailed analysis of uploaded resume
