...
Scores how well a resume matches a job description, then feeds the UI charts and recommendation lists.
...
- Suggestions panel: concrete items prioritized by lost points and JD alignment.
