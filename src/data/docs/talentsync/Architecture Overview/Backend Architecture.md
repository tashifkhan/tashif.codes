...
The FastAPI backend architecture for the TalentSync project.

## Repository layout
The backend is organized around a FastAPI application :
...
## Dependencies
- Runtime dependencies include FastAPI, LangChain stack, PyMuPDF for PDF processing, SSE support, and HTTP client libraries
