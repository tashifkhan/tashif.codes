...
The Interview data models and workflows in the system.
...
The interview workflow integrates FastAPI routes, a LangGraph orchestrator, and service components for question generation, evaluation, and code execution. Sessions are managed in-memory but built for persistence.
...
- Session Management
 - SessionManager maintains in-memory sessions and events; built for persistence extension
