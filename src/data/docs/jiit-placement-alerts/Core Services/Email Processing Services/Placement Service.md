...
2. Extraction: LLM-based structured extraction with reliable retry logic.
...
The system defines a detailed schema for placement offers:
...
- Forwarded Metadata Extraction: Reliable parsing of forwarded dates and senders to maintain accurate timestamps and attribution.
