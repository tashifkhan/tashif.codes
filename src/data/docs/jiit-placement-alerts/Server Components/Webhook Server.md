...
## Introduction
FastAPI webhook server for REST and external triggers. Routes, auth/CORS, validation, errors, and how it shares NotificationService and DatabaseService with the bot process.
